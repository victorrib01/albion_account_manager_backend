...
export class albionManagerDbV31609439830441 implements MigrationInterface {
    name = 'albionManagerDbV31609439830441'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "island_type" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_386e9510c81ef5914b509970666" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "islands" ADD CONSTRAINT "FK_4e929c20ddcfaa145fe46fc0e01" FOREIGN KEY ("island_type_id") REFERENCES "island_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "island_type"`);
